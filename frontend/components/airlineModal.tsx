...
const AirlineModal: React.FC<AirlineModalProps> = ({ isOpen, onClose, onSubmit }) => {
    ...
    <div className="fixed inset-0 z-[1000] flex justify-center items-center p-4 pointer-events-none">
      <div className="bg-white p-6 rounded-lg shadow-xl z-[1010] w-full max-w-md mx-4 pointer-events-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-800">Agregar Aerolínea Privada</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="iata" className="block text-sm font-medium text-gray-700 mb-1">Código IATA (Opcional)</label>
            <input
              type="text"
              id="iata"
              name="iata"
          ...
          <div>
            <label htmlFor="icao" className="block text-sm font-medium text-gray-700 mb-1">Código ICAO (Opcional)</label>
            <input
              type="text"
              id="icao"
              name="icao"
          ...
          <div>
            <label htmlFor="countryCode" className="block text-sm font-medium text-gray-700 mb-1">Código de País (Opcional)</label>
            <input
              type="text"
              id="countryCode"
              name="countryCode"
