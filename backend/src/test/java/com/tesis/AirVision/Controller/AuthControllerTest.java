...
public class AuthControllerTest {
    ...
    void Login_Success() throws Exception {
        ...
        LoginResponse loginResponse = new LoginResponse("Login exitoso", "USER");
    ...
    void login_UserNotFound() throws Exception {
        ...
        LoginResponse response = new LoginResponse("Usuario no encontrado", null);
    ...
    void login_InvalidCredentials() throws Exception {
        ...
        LoginResponse response = new LoginResponse("Credenciales inválidas", null);
