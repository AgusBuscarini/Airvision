...
public class StatsServiceImpl implements StatsService {
    ...
    public StatsResponseDto getDashboardStats() {
        ...
        return StatsResponseDto.builder()
                .global(calculateStats(globalData))
                .publicFlights(calculateStats(publicData))
                .privateFlights(calculateStats(privateData))
                .build();
    }

    private record FlightStatData(String country, Boolean onGround) {}

    private StatsResponseDto.FlightStats calculateStats(List<FlightStatData> flights) {
        ...
        List<StatsResponseDto.StatItem> topCountries = countryCounts.entrySet().stream()
